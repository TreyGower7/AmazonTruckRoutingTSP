...
public void start() throws InterruptedException
    ...
    //Character Info
    System.out.println();
     System.out.println("Hello welcome to Dragon Fight Club a Turn Based Rpg.");
...
TimeUnit.SECONDS.sleep(5);
   ...
   //transition to body of game
            System.out.println();
   System.out.println("With your new trusty sword " + name + " of " + Guild + " we can now send you off to start your adventure in the world of dragons.");
